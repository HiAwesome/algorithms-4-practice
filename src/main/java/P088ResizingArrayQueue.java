...
/**
 * The {@code P088ResizingArrayQueue} class represents a first-in-first-out (FIFO)
 ...
 * @author Kevin Wayne
 */
public class P088ResizingArrayQueue<Item> implements Iterable<Item> {
