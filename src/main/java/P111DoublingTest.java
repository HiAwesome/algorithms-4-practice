...
/******************************************************************************
 *  Compilation:  javac P111DoublingTest.java
 *  Execution:    java P111DoublingTest
 *  Dependencies: ThreeSum.java Stopwatch.java StdRandom.java StdOut.java
 *
 *  % java P111DoublingTest
 *      250     0.0
 *      500     0.0
 *     1000     0.1
 *     2000     0.6
...
/**
 * The {@code P111DoublingTest} class provides a client for measuring
