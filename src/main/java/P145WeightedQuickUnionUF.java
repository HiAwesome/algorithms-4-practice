...
/******************************************************************************
 *  Compilation:  javac P145WeightedQuickUnionUF.java
 *  Execution:  java P145WeightedQuickUnionUF < input.txt
...
/**
 * The {@code P145WeightedQuickUnionUF} class represents a <em>union–find data type</em>
 ...
 * {@link P138UF}, {@link P140QuickFindUF}, and {@link P141QuickUnionUF}.
 ...
 * @author Kevin Wayne
 */
public class P145WeightedQuickUnionUF {
     ...
     */
    public P145WeightedQuickUnionUF(int n) {
        count = n;
        parent = new int[n];
        size = new int[n];
        for (int i = 0; i < n; i++) {
    ...
    public static void main(String[] args) {
        int n = StdIn.readInt();
        P145WeightedQuickUnionUF uf = new P145WeightedQuickUnionUF(n);
        while (!StdIn.isEmpty()) {
            int p = StdIn.readInt();
            int q = StdIn.readInt();
